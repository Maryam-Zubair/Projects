...
class LLMResponse:
    ...
    def __load_chatbot(self, k = 3, chain_type='stuff'):
       ...
       # Create a ConversationBufferMemory
        ...
        qa = ConversationalRetrievalChain.from_llm(
            llm=ChatOpenAI(model_name="ft:gpt-3.5-turbo-1106:personal::8OJWhpib", temperature=0),
    ...
    def send_translated_email(self, user_email, user_language):
        # Translate the standard email content
        translated_content = self.__translator("I'm glad to hear about your interest in SFBU University! If you have any further questions or need more information, please don't hesitate to reach out. You can easily ask your questions or express any concerns through their dedicated contact page. Just follow this link to the SFBU University website: https://www.sfbu.edu/contact-us There, you'll find a straightforward way to get in touch with the university representatives who are always ready to assist you with any inquiries you might have. Whether it's about academic programs, campus life, admissions, or anything else related to SFBU University, they're there to help you every step of the way.", source_language='en', target_language=user_language)

        message = Mail(
            from_email='mariyam051@gmail.com',  # Replace with your sender email
            to_emails=user_email,
            subject='SFBU University',
            plain_text_content=translated_content
        )
        try:
